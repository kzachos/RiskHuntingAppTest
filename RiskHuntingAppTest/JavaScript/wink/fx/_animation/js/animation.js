...
(function(winkfx)
{
	 ...
	 *		}
	 */
	winkfx.animate = function(node, transitions, options)
	{
	 ...
	 *		}
	 */
	winkfx.fadeIn = function(node, options)
	{
	 ...
	 *		}
	 */
	winkfx.fadeOut = function(node, options)
	{
	 ...
	 *		}
	 */
	winkfx.collapse = function(node, options)
	{
		var opts = options || {};
	 ...
	 */
	winkfx.split = function(node, rows, cols)
	{
