...
(function(winkmath)
{
	 ...
	 */
	winkmath.radToDeg = function(angleRad)
	{
	 ...
	 */
	winkmath.degToRad = function(angleDeg)
	{
	 ...
	 */
	winkmath.getAngle = function(radius, distance)
	{
	 ...
	 *	--> v: second vector
	 */
	winkmath.getAngleBetweenVectors = function(u, v)
	{
		var scalar = winkmath.getScalarVector(u, v);
		var norms = winkmath.getNormVector(u) * winkmath.getNormVector(v);
	 ...
	 */
	winkmath.normalizeVector = function(u)
	{
		var result = [ 0, 0, 0, 1 ];
		var norm = winkmath.getNormVector(u);
	 ...
	 *	--> u: the vector
	 */
	winkmath.getNormVector = function(u)
	{
	 ...
	 *	--> v: second vector
	 */
	winkmath.getNormalVector = function(u, v)
	{
		var vector = [ 0, 0, 0, 1 ];
	 ...
	 *	--> v: second vector
	 */
	winkmath.getScalarVector = function(u, v)
	{
		var scalar = 0;
	 ...
	 *	--> p2: the second point
	 */
	winkmath.getVector = function(p1, p2)
	{
		var vector = [ 0, 0, 0, 1 ];
		vector[0] = p2[0] - p1[0];
		vector[1] = p2[1] - p1[1];
	 ...
	 *	--> vector: the vector
	 */
	winkmath.multiplyMatrixVector = function(matrix, vector)
	{
		var result = [ 0, 0, 0, 1 ];
		if (!vector[3])
		{
